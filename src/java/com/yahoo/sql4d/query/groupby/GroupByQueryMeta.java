...
//        }
    ...
    public static class Builder{
        private GroupByQueryMeta meta ;
        public Builder(){
            this.meta = new GroupByQueryMeta();
            this.meta.queryType = RequestType.GROUPBY;
        }

        public Builder setGranularity(Granularity gran){
            this.meta.granularity = gran;
            return this;
        }
